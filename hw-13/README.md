# HW-13 — TypeORM data layer (archived)

Archived snapshot of the HW-13 submission. The live course tree continues at the
repository root (`hw-14` and later).

Marketplace schema from [HW-12](../hw-12) became a TypeORM data layer: entities,
...
`scripts/with-secrets.sh` fills via Infisical.
